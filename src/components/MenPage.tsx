...
const MenPage = () => {
  ...
  const categories = [
    { id: 'all', name: 'All', count: menProducts.length },
    { id: 'running', name: 'Running', count: menProducts.filter(p => p.category === 'running').length },
    { id: 'lifestyle', name: 'Lifestyle', count: menProducts.filter(p => p.category === 'lifestyle').length },
    { id: 'training', name: 'Training', count: menProducts.filter(p => p.category === 'training').length },
    { id: 'basketball', name: 'Basketball', count: menProducts.filter(p => p.category === 'basketball').length }
  ];
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-8 gap-4">
          <div>
            <h2 className="text-2xl font-bold text-slate-900 mb-2">
              Men's Shoes ({filteredProducts.length})
            </h2>
